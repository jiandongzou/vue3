(function () {
    ...
    function initButtons() {
        dialog.onok = function () {
            ...
            switch (id) {
                case 'remote':
                    list = insertaudio.audioList;
                    break;
                case 'upload':
                    list = uploadaudio.audioList;
                    ...
                    for (let index = 0; index < list.length; index++) {
                        var id=list[index].title.split(".")[0]
                       list[index].id=id;
                    }
                    break;
            }
...
//            });
console.log(editor.getOpt('audioAllowFiles'));
            setState('pedding');
            ...
            uploader.on('uploadSuccess', function (file, ret) {
                ...
                try {
                    ...
                    if (json.state == 'SUCCESS') {
                        ...
                        var tempUrl= json.url;
                        json.url=prefix+tempUrl;
